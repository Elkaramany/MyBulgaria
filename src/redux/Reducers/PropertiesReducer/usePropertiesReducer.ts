...
import { PropertiesState, PropertyType, Review, GalleryImage, CategoryType, ProvinceType } from './types';
...
export type { PropertyType, Review, GalleryImage, CategoryType, ProvinceType }